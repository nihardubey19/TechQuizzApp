...
public class ViewScoresFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jrViewSingleScore = new javax.swing.JRadioButton();
        jrViewAllScores = new javax.swing.JRadioButton();
        ...
        jLabel7.setText("Make a Choice");

        buttonGroup2.add(jrViewSingleScore);
        jrViewSingleScore.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jrViewSingleScore.setForeground(new java.awt.Color(51, 51, 255));
        jrViewSingleScore.setText("View Score Of a Single Student ");

        buttonGroup2.add(jrViewAllScores);
        jrViewAllScores.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jrViewAllScores.setForeground(new java.awt.Color(51, 51, 255));
        jrViewAllScores.setText("View All Scores");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jrViewAllScores)
                    .addComponent(jrViewSingleScore)
    ...
    private void btnDoTaskActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDoTaskActionPerformed
        ...
        if(jrViewSingleScore.isSelected()){
            ViewSingleScoreFrame singleScoreFrame=new ViewSingleScoreFrame();
            singleScoreFrame.setVisible(true);            
        }
        else{
            ViewAllScoresFrame viewAllScoreFr=new ViewAllScoresFrame();
            viewAllScoreFr.setVisible(true);
        }
        this.dispose();
    ...
    private javax.swing.JRadioButton jrViewAllScores;
    private javax.swing.JRadioButton jrViewSingleScore;
    private javax.swing.JLabel lblLogout;
    private javax.swing.JLabel lblUserName;
    // End of variables declaration//GEN-END:variables

    private boolean validateInput() {
        if(jrViewSingleScore.isSelected() == false && jrViewAllScores.isSelected()==false)
            return false;
        return true;
    }
}   
